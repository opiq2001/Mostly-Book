...
/**
 * Kelas MainActivity.java merupakan main program
 * Class MainActivity.java is main program
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, com.MostlyBook.shop.LoginActivity.class);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child("Users").child(name).exists()){
                    ...
                    Toast.makeText(MainActivity.this, "Account named" + name + " number do not exists.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
