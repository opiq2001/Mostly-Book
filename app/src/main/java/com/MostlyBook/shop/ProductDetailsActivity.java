...
/**
 * Kelas ProductDetailsActivity.java untuk menampilkan halaman detail product
 * Class ProductDetailsActivity.java to show product detail page
 */
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    /**
     *
     * menambahkan produk ke list cart
